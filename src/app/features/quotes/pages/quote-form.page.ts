  ...
  template: `
    <div class="space-y-6">
      <app-page-header
        ...
        description="Ingresá los datos del envío para comparar tarifas de couriers."
        [breadcrumbs]="breadcrumbs"
      ></app-page-header>

      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="grid grid-cols-1 gap-6 lg:grid-cols-3" novalidate>
        <!-- Main form card -->
        <div class="card lg:col-span-2">
          <div class="card-header">
            ...
            <p class="card-description">Datos del recorrido del envío.</p>
          </div>
          <div class="card-content space-y-4">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                <label class="label">Zona origen</label>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                <label class="label">Zona destino</label>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div>
                <label for="distanceKm" class="label">Distancia (km)</label>
              ...
              <div>
                <label for="weightKg" class="label">Peso (kg)</label>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <p class="card-description">Datos del bulto y tipo de envío.</p>
          </div>
          <div class="card-content space-y-4">
            <div class="grid grid-cols-3 gap-3">
              <div>
                <label for="lengthCm" class="label">Largo (cm)</label>
                <input id="lengthCm" type="number" step="any" min="0" formControlName="lengthCm" class="input mt-1.5" />
              </div>
              <div>
                <label for="widthCm" class="label">Ancho (cm)</label>
                <input id="widthCm" type="number" step="any" min="0" formControlName="widthCm" class="input mt-1.5" />
              </div>
              <div>
                <label for="heightCm" class="label">Alto (cm)</label>
            ...
            <div class="rounded-md bg-muted/40 p-3 text-xs text-muted-foreground">
              <p>Volumen aproximado: <span class="font-medium text-foreground">{{ volume() }} cm³</span></p>
              <p class="mt-1">Peso volumétrico: <span class="font-medium text-foreground">{{ volWeight() }} kg</span></p>
            </div>
          </div>
        </div>
        ...
        <div class="lg:col-span-3 flex justify-end gap-2">
          <button type="button" class="btn btn-outline btn-md" (click)="goDashboard()">Cancelar</button>
...
export class QuoteFormPageComponent {
  ...
  onSubmit(): void {
    ...
    setTimeout(() => {
      try {
        const created = this.api.createQuote({
          origin: v.origin,
